...
import (
	"fmt"
	"getArea/auth/interceptor"
	"getArea/auth/tls"
	"getArea/conf"
	"getArea/controller"
	"getArea/dao/mysql"
	myredis "getArea/dao/redis"
	"getArea/discovery"
	"getArea/pb/getArea"
	"net"
...
func main() {
	...
	//将服务结构体注册到grpc服务中
	getArea.RegisterGetAreaServer(srv, controller.New())
	...
	// etcd中注册服务
	if _, err := etcdRegister.Register(getAreaNode, 10); err != nil {
